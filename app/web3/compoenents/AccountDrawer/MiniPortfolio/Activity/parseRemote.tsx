...
function getSwapTitle(
  ...
  if (
    ...
    isSameAddress(
      nativeOnChain(fromGraphQLChain(sent.asset.chain)).wrapped.address,
    ...
    isSameAddress(
      nativeOnChain(fromGraphQLChain(received.asset.chain)).wrapped.address,
      received.asset.address,
    )
  ) {
    return t`Unwrapped`;
...
export function parseRemoteActivities(
  assetActivities?: AssetActivityPartsFragment[],
) {
