...
const StyledButton = styled.button<{ padded?: boolean; branded?: boolean }>`
  ...
  background: ${({ theme, branded }) =>
    branded ? theme.promotionalGradient : theme.backgroundInteractive};
  border-radius: 12px;
  ...
  line-height: 16px;
  color: ${({ theme, branded }) =>
    branded ? theme.accentTextLightPrimary : theme.textPrimary};
`;
...
const APP_STORE_LINK =
  "https://apps.apple.com/app/apple-store/id6443944476?pt=123625782&ct=In-App-Banners&mt=8";
